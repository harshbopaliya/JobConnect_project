...
class Company(models.Model):
    ...
    industry = models.ForeignKey(
        Industry, on_delete=models.SET_NULL, null=True, related_name='companies')
    ...
    employee_count = models.CharField(
        max_length=10, choices=employee_count_choices, default='1-10')
...
class Culture(models.Model):
    company = models.ForeignKey(
        Company, on_delete=models.CASCADE, related_name='culture')
    text = models.CharField(max_length=255)
