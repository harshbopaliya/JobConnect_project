...
import { Building, MapPin, Users, Star, Globe, Clock, Briefcase, DollarSign, Calendar, Mail, Facebook, Twitter, Linkedin, Instagram } from 'lucide-react';
...
const CompanyDetail = () => {
  ...
  const company = {
    ...
    mission: "Our mission is to transform businesses through technology and deliver exceptional digital experiences that drive growth and success for our clients.",
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                        <div className="flex flex-col space-y-6">
                          <div className="flex items-start">
                            <MapPin size={18} className="mr-3 mt-1 text-jobconnect-teal" />
                            <div>
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-gray-600">{company.employeeCount} employees</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex flex-col space-y-6">
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <a href={company.website} target="_blank" rel="noopener noreferrer" className="text-jobconnect-teal hover:underline">
                          ...
                          <div className="flex items-start">
                            <Calendar size={18} className="mr-3 mt-1 text-jobconnect-teal" />
                            <div>
                            ...
                            <CardContent className="p-0">
                              <div className="flex flex-col md:flex-row border-l-4 border-jobconnect-teal">
                                <div className="flex-grow p-4">
                                  <Link to={`/jobs/${job.id}`} className="text-lg font-semibold hover:text-jobconnect-teal transition-colors">
                                    {job.title}
                                  </Link>
                                  
                                  <div className="flex flex-wrap gap-y-2 gap-x-4 text-sm text-gray-500 mt-2">
                                    <div className="flex items-center">
                                      <MapPin size={14} className="mr-1 text-jobconnect-teal" />
                                    ...
                                    <div className="flex items-center">
                                      <DollarSign size={14} className="mr-1 text-jobconnect-teal" />
                                      <span>{job.salary}</span>
                                    </div>
                                    
                                    <div className="flex items-center">
                                      <Briefcase size={14} className="mr-1 text-jobconnect-teal" />
                                      <span>{job.type}</span>
                                    </div>
                                    
                                    <div className="flex items-center">
                                      <Clock size={14} className="mr-1 text-jobconnect-teal" />
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start">
                      <Mail size={18} className="mr-3 mt-1 text-jobconnect-teal" />
                      <div>
                        <p className="font-medium">Email</p>
                        <a href={`mailto:${company.email}`} className="text-jobconnect-teal hover:underline">
                          {company.email}
                        </a>
                      </div>
                    </div>
