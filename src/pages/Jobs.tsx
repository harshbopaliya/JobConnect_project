...
import { Search, MapPin, Briefcase, Clock, DollarSign, Building, Bookmark, Filter } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-jobconnect-navy py-8">
        <div className="container mx-auto px-6">
          ...
          <p className="text-gray-300 mb-6">Find your next opportunity from our extensive job listings</p>
      ...
      <div className="flex-grow bg-gray-50 py-8">
        <div className="container mx-auto px-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-lg font-semibold">Found {jobListings.length} jobs</h2>
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col md:flex-row md:items-center">
                    ...
                    <div className="flex-grow md:mr-6">
                      <Link to={`/jobs/${job.id}`} className="text-xl font-semibold hover:text-jobconnect-teal transition-colors">
                        {job.title}
                      </Link>
                    ...
                    <div className="flex items-center mt-4 md:mt-0">
                      <Button variant="ghost" size="icon" className="text-gray-400 hover:text-jobconnect-orange mr-2">
          ...
          <div className="flex justify-center mt-8">
            ...
            <Button variant="outline" className="mx-1 bg-jobconnect-navy text-white">1</Button>
