...
// import { toast } from "@/components/ui/use-toast"; // If you're using toast
...
//                   <TabsTrigger
//                     value="jobseeker"
//                     className="flex items-center gap-2 data-[state=active]:bg-jobconnect-teal data-[state=active]:text-white"
//                   >
//                     <UserPlus size={16} /> Job Seeker
//                   </TabsTrigger>
//                   <TabsTrigger
//                     value="employer"
//                     className="flex items-center gap-2 data-[state=active]:bg-jobconnect-orange data-[state=active]:text-white"
//                   >
...
//                           <Link
//                             to="/forgot-password"
//                             className="text-xs text-jobconnect-teal hover:underline"
//                           >
//                             Forgot password?
//                           </Link>
//                         </div>
...
//                       <Button
//                         type="submit"
//                         className="w-full bg-jobconnect-teal hover:bg-jobconnect-teal/90 mb-4"
//                       >
...
//                           <Link
//                             to="/forgot-password"
//                             className="text-xs text-jobconnect-orange hover:underline"
//                           >
//                             Forgot password?
//                           </Link>
//                         </div>
...
//                           }
//                         />
//                         <Label htmlFor="employer-remember" className="text-sm">
//                           Remember me
//                         </Label>
//                       </div>
//                     </CardContent>
...
//                       <Button
//                         type="submit"
//                         className="w-full bg-jobconnect-orange hover:bg-jobconnect-orange/90 mb-4"
//                       >
...
//                           className="text-jobconnect-orange hover:underline"
//                         >
